...
/**
 * These functions abstracts away the "emission" of events/signals relating to job statuses via mutations to the database. 
 */
 ...
 */
export async function registerLogs(job: Job, message: string) {
