...
class RHESSysMaintainer extends BaseMaintainer {
    private remote_id
    ...
    async onInit() {
        ...
        var params = await this.runPython('RHESSys/init.py', [
            username,
    ...
    async onMaintain() {
        await this.runPython('RHESSys/maintain.py', [
            this.machine,
            this.username,
            __dirname + '/../../key/cigi-gisolve.key',
            this.remote_id,
...
export default RHESSysMaintainer