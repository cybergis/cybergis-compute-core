...
var RHESSysMaintainer = (function (_super) {
    __extends(RHESSysMaintainer, _super);
    function RHESSysMaintainer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RHESSysMaintainer.prototype.define = function () {
        this.allowedEnv = {};
    };
    RHESSysMaintainer.prototype.onInit = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.runPython('RHESSys/init.py', [
                                username,
    ...
    RHESSysMaintainer.prototype.onMaintain = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.runPython('RHESSys/maintain.py', [
                            this.machine,
                            this.username,
                            __dirname + '/../../key/cigi-gisolve.key',
                            this.remote_id,
    ...
    return RHESSysMaintainer;
}(BaseMaintainer_1.default));
exports.default = RHESSysMaintainer;
