            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4, this.redis.push([this.name, itemString])];
                    case 2:
                        _a.sent();
                        return [2];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        _b = (_a = JSON).parse;
                        return [4, this.redis.shift(this.name)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.redis.length(this.name)];
                    case 2: return [2, (_a.sent()) === 0];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        _c = (_b = JSON).parse;
                        return [4, this.redis.peak(this.name, 0, 0)];
                    case 4:
